...
function basic_setup() {
	...
	register_nav_menus( array(
		...
		'footer-menu' => __( 'Footer Menu', 'basic' ),
	) );
...
function basic_scripts() {
	...
	wp_enqueue_script( 'basic-jquery', get_template_directory_uri() . '/js/jquery-3.1.1.min.js', array(), '20151215', true );

	wp_enqueue_script( 'basic-fancyboxjs', get_template_directory_uri() . '/js/jquery.fancybox.min.js', array(), '20151215', true );

	wp_enqueue_style( 'basic-fancyboxcss', get_template_directory_uri() . '/sass/variables-site/jquery.fancybox.min.css', array(), '20151215', true );

	wp_enqueue_script( 'basic-mainjs', get_template_directory_uri() . '/js/main.js', array(), '20151215', true );
