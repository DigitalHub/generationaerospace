...
$featured_month_sql = $wpdb->prepare("SELECT t1.id as video_id, t1.title as video_title, t1.description as video_desc, t1.youtube as video_link, t1.favourite, t3.post_date as posted_date, t2.username as posted_by_username, t2.fullname as posted_by, t2.photo as profile_pic, t2.is_fb_user as is_fb_user FROM $videos_table t1 INNER JOIN $members_table t2 ON t1.member_id = t2.id INNER JOIN $wpdb->posts t3 ON t1.link_id = t3.id WHERE t1.link_id = '%s' AND t3.post_status = 'publish'", $post_id);
