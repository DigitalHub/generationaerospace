			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 content-area" id="primary">
					...
					<?php if (  $the_query->max_num_pages > 1 ) {
						echo '<div class="row"><a href="#" class="defaultbtn btn--default aligncenter genaero_loadmore" data-cpt="'.$cpt.'" data-posts_per_page="'.$posts_per_page.'" data-template="'.$template.'"><div class="defaultbtn-wrapper"><span>See More Trailblazers</span></div></a></div>';
					} ?>
				</div><!-- #primary -->
			</div><!-- .row end -->
		</div><!-- Container end -->
