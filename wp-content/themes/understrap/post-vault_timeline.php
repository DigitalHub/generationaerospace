<?php
/**
 * Template Name: Genaero Timeline
 * Template Post Type: genaero_vault
 *
 * @package understrap
 */
				...
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 content-area" id="primary">
					<main class="site-main" id="main" role="main">
						<?php while ( have_posts() ) : the_post(); ?>
							<?php the_content(); ?>
							<div class="clear"></div>
							<div class="default-slick">
								<?php $vault_timeline_images = get_field('vault_timeline_images');
								$size = 'full'; 
								if( $vault_timeline_images ): foreach( $vault_timeline_images as $vault_timeline_image ): ?>
								<div><?php echo wp_get_attachment_image( $vault_timeline_image['ID'], $size ); ?></div>
