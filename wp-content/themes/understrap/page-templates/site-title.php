...
<div class="site-branding mainlogo">
	<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">
		<svg class="HudTitle-border HudTitle-border--left" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 15.5 42" xml:space="preserve">
		...
		<svg class="HudTitle-border HudTitle-border--right" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 15.5 42" xml:space="preserve">
			<rect x="0.5" y="0.5" width="3" height="41"></rect>
			<polyline points="8.5,15.9 8.5,0.5 15.5,0.5"></polyline>
			<polyline points="15.5,41.5 8.5,41.5 8.5,26.1"></polyline>
			<circle cx="8.5" cy="21" r="2.5"></circle>
...
<div class="site-menu">
	<div class="headerbutt menu_butt">
