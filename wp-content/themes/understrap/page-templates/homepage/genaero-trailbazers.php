...
if($trailblazer) :
	...
	<section class="section" data-anchor="genaero_trailblazers">
		...
		<div class="container sub_content featured_trailbazers">
			<div class="row">
				<div class="offset-xl-1 col-xl-4 offset-lg-1 col-lg-4 col-md-12 col-sm-12 col-sm-12 animated_circles--wrapper featured_trailbazers--img">
				...
				<div class="offset-xl-0 col-xl-6 offset-lg-0 col-lg-6 offset-md-1 col-md-10 col-sm-12 col-sm-12">
