			...
			<div class="col-xl-10 offset-xl-1">
				...
				<div class="genaero_explorer--carousel">
					<div class="explorer_slide">
						...
						<h2>Make a difference in the world</h2>
						<p class="highlight">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga nobis molestias sequi beatae? Ipsa ut sed nisi, odio fugit beatae, neque quisquam tempora saepe animi enim iste similique consequuntur eum quia ex dolore aliquid. Perspiciatis magnam, dicta ess!</p>
					</div>
					<div class="explorer_slide">
						<div class="post-thumbnail">
							<img src="http://lorempixel.com/500/270" />
						</div>
						<h2>Make a difference in the world</h2>
						<p class="highlight">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga nobis molestias sequi beatae? Ipsa ut sed nisi, odio fugit beatae, neque quisquam tempora saepe animi enim iste similique consequuntur eum quia ex dolore aliquid. Perspiciatis magnam, dicta esse, natus, debitis repudiandae</p>
					</div>
					<div class="explorer_slide">
						<div class="post-thumbnail">
							<img src="http://lorempixel.com/500/220" />
						</div>
						<h2>Make a difference in the world</h2>
						<p class="highlight">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga nobis molestias sequi beatae? Ipsa ut sed nisi, odio fugit beatae, neque quisquam tempora saepe animi enim iste similique consequuntur eum quia ex dolore aliquid. Perspiciatis magnam, dicta ess!</p>
					</div>
